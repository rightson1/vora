...
import { CommentFetched } from "@/types";
...
import { useDeleteComment } from "@/utils/hooks/useComments";
import { scrollToParentComment } from "../helpers/functions";
import toast from "react-hot-toast";
const Comments = ({ comments }: { comments: CommentFetched[] }) => {
        ...
        return (
          <>
            ...
            >
              ...
              >
                <MenuItem onClick={() => handleCommentDelete(comment._id)}>
                  Delete
                </MenuItem>
              </CustomCardHeader>
              {parentComment && (
